...
from ..Components.mailbox_component import MailboxComponent
...
class MailboxService(Resource):
    @staticmethod
    def get():
        try:
            HandleLogs.write_log("Ejecutando servicio de Listar buzon")
            ...
            resultado = MailboxComponent.mailbox()
            if resultado['result']:
